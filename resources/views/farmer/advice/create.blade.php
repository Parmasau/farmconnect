...
@section('title', 'Ask for Advice - FarmNest')
        ...
        <form method="POST" action="{{ route('farmer.advice.store') }}">
            ...
            <div class="mb-4">
                ...
                <select name="agrovet_id" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none">
                    <option value="">Any Agrovet (First available)</option>
                ...
                @enderror
                <p class="text-xs text-gray-500 mt-1">If you select a specific agrovet, the request will go only to them.</p>
            </div>
