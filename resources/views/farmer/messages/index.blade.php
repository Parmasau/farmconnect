...
<div class="bg-white/95 backdrop-blur-sm rounded-xl shadow p-6">
            ...
            @foreach($messages as $message)
                @php
                    ...
                    $unreadCount = App\Models\Message::where('sender_id', $otherUser->id)
                                                   ...
                                                   ->count();
                @endphp
                <a href="{{ route('farmer.messages.show', $otherUser->id) }}" class="block py-4 hover:bg-gray-50 transition">
                        ...
                        <div class="flex-1">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ Str::limit($message->body, 50) }}</p>  <!-- Changed from content to body -->
                                </div>
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="text-gray-500 mb-4">Start a conversation with other farmers or agrovets</p>
            <a href="{{ route('farmer.products.marketplace', ['seller' => 'farmer']) }}" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700">
                Browse Products
            </a>
        </div>
    @endif
