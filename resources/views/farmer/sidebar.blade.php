{{-- resources/views/farmer/sidebar.blade.php --}}
<div class="space-y-2">
    ...
    <a href="{{ route('farmer.my-orders') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/20 text-white {{ request()->routeIs('farmer.my-orders') ? 'bg-white/20' : '' }}">
        <i class="fas fa-shopping-cart w-5"></i> My Orders
    </a>
    ...
    <a href="{{ route('farmer.products.agrovet') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/20 text-white">
