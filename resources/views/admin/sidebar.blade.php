<div class="space-y-2">
    ...
    <a href="{{ route('admin.reports.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/20 text-white {{ request()->routeIs('admin.reports.*') ? 'bg-white/20' : '' }}">
