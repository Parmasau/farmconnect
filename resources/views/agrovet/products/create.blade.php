    ...
    <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow p-6">
        ...
        <form method="POST" action="{{ route('agrovet.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500" required>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500" required></textarea>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" step="0.01" name="price" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500" required>
                    @error('price') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1">Quantity *</label>
                    <input type="number" name="quantity" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500" required>
